...
{
    m_commonVoxels[(u8)CommonVoxel::Air] = getVoxelId("air");
    m_commonVoxels[(u8)CommonVoxel::Stone] = getVoxelId("stone");
    m_commonVoxels[(u8)CommonVoxel::Grass] = getVoxelId("grass");
    m_commonVoxels[(u8)CommonVoxel::Dirt] = getVoxelId("dirt");
    m_commonVoxels[(u8)CommonVoxel::Sand] = getVoxelId("sand");
    m_commonVoxels[(u8)CommonVoxel::Water] = getVoxelId("water");
}
